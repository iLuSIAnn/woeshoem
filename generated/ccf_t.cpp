...
static void ecall_enclave_create_node(
    ...
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    enclave_create_node_args_t* pargs_in = (enclave_create_node_args_t*)input_buffer;
    enclave_create_node_args_t* pargs_out = (enclave_create_node_args_t*)output_buffer;
    ...
    if (pargs_in->node_cert)
        OE_SET_OUT_POINTER(node_cert, ((size_t)pargs_in->node_cert_size * sizeof(uint8_t)), uint8_t*);
    if (pargs_in->node_cert_len)
        OE_SET_OUT_POINTER(node_cert_len, sizeof(size_t), size_t*);
    if (pargs_in->network_cert)
        OE_SET_OUT_POINTER(network_cert, ((size_t)pargs_in->network_cert_size * sizeof(uint8_t)), uint8_t*);
    if (pargs_in->network_cert_len)
        OE_SET_OUT_POINTER(network_cert_len, sizeof(size_t), size_t*);
    ...
    /* Call user function. */
    pargs_out->_retval = enclave_create_node(
        pargs_in->enclave_config,
        pargs_in->ccf_config,
        pargs_in->ccf_config_size,
        pargs_in->node_cert,
        pargs_in->node_cert_size,
        pargs_in->node_cert_len,
        pargs_in->network_cert,
        pargs_in->network_cert_size,
        pargs_in->network_cert_len,
        pargs_in->start_type,
        pargs_in->consensus_type,
        pargs_in->num_worker_thread,
        pargs_in->time_location);
...
oe_ecall_func_t __oe_ecalls_table[] = {
    (oe_ecall_func_t) ecall_enclave_create_node,
...
enum
{
    ccf_fcn_id_oe_get_supported_attester_format_ids_ocall = 0,
    ccf_fcn_id_oe_get_qetarget_info_ocall = 1,
    ccf_fcn_id_oe_get_quote_ocall = 2,
    ccf_fcn_id_oe_get_quote_verification_collateral_ocall = 3,
    ccf_fcn_id_oe_verify_quote_ocall = 4,
    ccf_fcn_id_oe_sgx_get_cpuid_table_ocall = 5,
    ccf_fcn_id_oe_sgx_backtrace_symbols_ocall = 6,
    ccf_fcn_id_oe_sgx_thread_wake_wait_ocall = 7,
    ccf_fcn_id_oe_sgx_wake_switchless_worker_ocall = 8,
    ccf_fcn_id_oe_sgx_sleep_switchless_worker_ocall = 9,
    ccf_fcn_id_oe_syscall_nanosleep_ocall = 10,
    ...
    size_t* format_ids_size_out)
{
    ...
    if ((_result = oe_call_host_function(
             ccf_fcn_id_oe_get_supported_attester_format_ids_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    sgx_target_info_t* target_info)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             ccf_fcn_id_oe_get_qetarget_info_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    size_t* qe_identity_issuer_chain_size_out)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             ccf_fcn_id_oe_get_quote_verification_collateral_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    uint32_t qe_identity_issuer_chain_size)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             ccf_fcn_id_oe_verify_quote_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    size_t cpuid_table_buffer_size)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             ccf_fcn_id_oe_sgx_get_cpuid_table_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    size_t* symbols_buffer_size_out)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             ccf_fcn_id_oe_sgx_backtrace_symbols_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    uint64_t self_tcs)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             ccf_fcn_id_oe_sgx_thread_wake_wait_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
oe_result_t oe_sgx_wake_switchless_worker_ocall(oe_host_worker_context_t* context)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             ccf_fcn_id_oe_sgx_wake_switchless_worker_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
oe_result_t oe_sgx_sleep_switchless_worker_ocall(oe_enclave_worker_context_t* context)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             ccf_fcn_id_oe_sgx_sleep_switchless_worker_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    struct oe_timespec* rem)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             ccf_fcn_id_oe_syscall_nanosleep_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
