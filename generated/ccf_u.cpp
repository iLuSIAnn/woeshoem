...
static const oe_ecall_info_t __ccf_ecall_info_table[] = 
{
    { "enclave_create_node" },
    { "enclave_run" },
    ...
    void* time_location)
{
    ...
    _args.network_cert = (uint8_t*)network_cert;
    _args.network_cert_size = network_cert_size;
    _args.network_cert_len = (size_t*)network_cert_len;
    _args.start_type = start_type;
    _args.consensus_type = consensus_type;
    ...
    if (node_cert)
        OE_ADD_SIZE(_output_buffer_size, ((size_t)_args.node_cert_size * sizeof(uint8_t)));
    if (node_cert_len)
        OE_ADD_SIZE(_output_buffer_size, sizeof(size_t));
    if (network_cert)
        OE_ADD_SIZE(_output_buffer_size, ((size_t)_args.network_cert_size * sizeof(uint8_t)));
    if (network_cert_len)
        OE_ADD_SIZE(_output_buffer_size, sizeof(size_t));
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             __ccf_ecall_info_table[ccf_fcn_id_enclave_create_node].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    *_retval = _pargs_out->_retval;
    OE_READ_OUT_PARAM(node_cert, (size_t)(((size_t)_args.node_cert_size * sizeof(uint8_t))));
    OE_READ_OUT_PARAM(node_cert_len, (size_t)(sizeof(size_t)));
    OE_READ_OUT_PARAM(network_cert, (size_t)(((size_t)_args.network_cert_size * sizeof(uint8_t))));
    OE_READ_OUT_PARAM(network_cert_len, (size_t)(sizeof(size_t)));
    ...
    bool* _retval)
{
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             __ccf_ecall_info_table[ccf_fcn_id_enclave_run].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    sgx_report_t* report)
{
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             __ccf_ecall_info_table[ccf_fcn_id_oe_get_sgx_report_ecall].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    size_t* report_buffer_size)
{
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             __ccf_ecall_info_table[ccf_fcn_id_oe_get_report_v2_ecall].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_report_t* parsed_report)
{
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             __ccf_ecall_info_table[ccf_fcn_id_oe_verify_local_report_ecall].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    uint64_t num_host_workers)
{
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             __ccf_ecall_info_table[ccf_fcn_id_oe_sgx_init_context_switchless_ecall].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_enclave_worker_context_t* context)
{
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             __ccf_ecall_info_table[ccf_fcn_id_oe_sgx_switchless_enclave_worker_thread_ecall].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
static oe_ocall_func_t __ccf_ocall_function_table[] = {
    ...
    oe_enclave_t** enclave)
{
    return oe_create_enclave(
               ...
               settings,
               setting_count,
               __ccf_ocall_function_table,
               11,
               __ccf_ecall_info_table,
                7,
               enclave);
}
